...
namespace EasyCashIdentityProject.PresentationLayer.Models
{
	public class CustomIdentityValidator : IdentityErrorDescriber
	{
		public override IdentityError PasswordTooShort(int length)
		{
			...
			{
				Code = "PasswordTooShort",   //metotun key'i
...
//Override - Metodun işlevini bozmadan onu ezerek istediğimiz formata sokmak. İki sayı toplamını override yaparak iki negatif sayı toplamı yapılabilir
