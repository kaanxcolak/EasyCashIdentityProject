...
{
    public class AppUserRegisterValidator:AbstractValidator<AppUserRegisterDto> //AppUserRegisterDto eklememizin sebebi AppUser içerisinde kullanmayacağımız olanlarda var. SOLID prensiplerini unutmuyoruz!
    {
